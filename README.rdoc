...
*It has a 
 ...
 - a submission(replay) model with many different answers one ofor each tracker(question)
...
*The solution separates the concerns about data processing. 
 ...
 - it transforms the model data and digest it through charts providing an abstraction that the 
 chart library can consume.
 - provided abstraction allow us to use different tools: Google Charts, HighCharts or even D3.js 
